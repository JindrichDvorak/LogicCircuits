...
export class FourBitOutput extends Component {
    ...
    createComponent(nodeManager) {
        ...
        this.setupControlSwitch(this.digitSwitch, this.arrowUp, 4, 56, () => {
